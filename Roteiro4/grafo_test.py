...
class TestGrafo(unittest.TestCase):
    ...
    def test_arestas_ha_paralelas(self):
        self.assertTrue(self.g_p.arestas_ha_paralelas())
        self.assertFalse(self.g_p_sem_paralelas.arestas_ha_paralelas())
        self.assertFalse(self.g_c.arestas_ha_paralelas())
        self.assertFalse(self.g_c3.arestas_ha_paralelas())
        self.assertTrue(self.g_l1.arestas_ha_paralelas())
